<li class="relative flex items-center px-4">
    ...
    <a href="javascript:;" class="block p-0 transition-all text-sm ease-nav-brand @if (request()->is('profile') || request()->is('profile-edit')) text-white @else text-slate-500 @endif text-nav-brand" dropdown-trigger aria-expanded="false">
