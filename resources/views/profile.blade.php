...
@section('content')
  ...
  <div class="w-full px-6 mx-auto">
    <div class="relative flex items-center p-0 mt-6 overflow-hidden bg-center bg-cover min-h-75 rounded-2xl" style="background-image: url('{{asset("img/curved-images/curved0.jpg") }}'); background-position-y: 50%">
